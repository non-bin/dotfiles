...

{
  ...
  age.identityPaths = map (e: e.path) (lib.filter (e: e.type == "rsa" || e.type == "ed25519") config.services.openssh.hostKeys) ++ [ "/home/alice/.ssh/id_rsa" ]; # Decrypt secrets with the autogenerated host keys, and my ssh private key if available
