    ...
    hyprland = {
      ...
      settings = {
        ...
        gesture = [
          ...
          "3, up, dispatcher, exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 10%+"
          "3, down, dispatcher, exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 10%-"
        ...
        exec-once = [
          "waybar &"
          "~/dotfiles/scripts/reload-hyprpaper.sh -w &"
