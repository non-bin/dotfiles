...
const updateCounterColor = (counter, bgColor) => {
  counter.elements.main.style.setProperty(
    '--color',
    retIfNotSame(counter.phases?.[counter .state.phase].color || counter.color, bgColor) ||
      'color-mix(in oklab, var(--screen-color), rgba(255, 255, 255) 25%)'
  );
};
