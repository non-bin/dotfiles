...
<p>
  ...
  - Use liked songs and artists from other users in the same groups <br />
  <br />
  - I would use this data to create user profiles and identify similar users based
  on their interactions with artists.<br />
