...
export default class Screen {
  ...
  setPreference(key, value) {
    const newPreferenceValue = value;

    switch (key) {
      case 'mobileFullscreen':
        if (typeof newPreferenceValue !== 'boolean') return true;
        break;
    ...
    this.#configManager.setPreference(key, newPreferenceValue);
  }
  ...
  getPreference(key) {
    ...
    switch (key) {
      case 'mobileFullscreen':
        if (typeof preferenceValue !== 'boolean') return true;
