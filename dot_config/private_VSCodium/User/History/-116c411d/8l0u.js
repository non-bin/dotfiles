...
export default class Screen {
   ...
   * @returns {*}
   */
  static fallbackIfInvalidType(value, type, fallback) {
    if (typeof value !== type) {
      return fallback;
    }
   ...
   * @returns {*}
   */
  static fallbackIfInvalidValue(value, allowedValues, fallback) {
  ...
  getPreference(key) {
    ...
    switch (key) {
      case 'mobileFullscreen':
        return Screen.fallbackIfInvalidType(preferenceValue, 'boolean', false);
