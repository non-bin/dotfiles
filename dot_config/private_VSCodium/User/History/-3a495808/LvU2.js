...
/**
 * @typedef {import('./counter').Counter} Counter
 * @typedef {import('./counter').CounterEditHandler} CounterEditHandler
 * @typedef {import('./screen').ScreenGrid} ScreenGrid
 * @typedef {import('./screen').PostResetCallback} PostResetCallback
 */
