 ...
 * @property {[width:Number,height:Number]} size 0 indexed
 */
...
export default class Counter {
   ...
   * @param {EditHandler?} params.editHandler
   */
  constructor(params) {
  ...
  /**
   * Move or resize the counter (called by the {@link EditHandler})
   *
  ...
  /**
   * Incriment the counter, reset if we've reached the max, and change phase if needed
   *
